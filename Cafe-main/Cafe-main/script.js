...
function gerarRelatorio(){
  ...
  <p><strong>Chá:</strong> ${Chas}</p>
  <p><strong>Temperatura:</strong> ${temperatura}</p>
  <p><strong>Copos:</strong> ${Copos}</p>
  <p><strong>Xicara:</strong> ${Xicara}</p>
  <p><strong>Açucar:</strong> ${acucar}</p>
  <p><strong>Chocolate:</strong> ${Chocolate}</p>
  <p><strong>Caldas:</strong> ${caldas}</p>
  <p><strong>Leite:</strong> ${leite}</p>
