...
function gerarRelatorio(){
  ...
  const nome = document.getElementById("nome").vale;
  ...
  const forma_pagamento = document.getElementById("forma_pagamento").vale;
  ...
  <p><strong>Café</strong> ${Cafe.nome} - R$ ${custoCafe.toFixed(2)}</p>
  <p><strong>Chá:</strong> ${Chas.nome} - R$ ${custoChas.toFixed(2)}</p>
  <p><strong>Temperatura:</strong> ${temperatura.nome} - R$ ${custotemperatura.toFixed(2)}</p>
  <p><strong>Copos:</strong> ${Copos.nome} - R$ ${custoCopos.toFixed(2)}</p>
  <p><strong>Xicara:</strong> ${Xicaras.nome} - R$ ${custoXicaras.toFixed(2)}</p>
  <p><strong>Açucar:</strong> ${acucar.nome} - R$ ${custoacucar.toFixed(2)}</p>
  <p><strong>Chocolate:</strong> ${Chocolate.nome} - R$ ${custoChocolate.toFixed(2)}</p>
  <p><strong>Caldas:</strong> ${caldas.nome} - R$ ${custocaldas.toFixed(2)}</p>
  <p><strong>Leite:</strong> ${leites.nome} - R$ ${custoCafe.toFixed(2)}</p>
